...
vol['pamx'] = [1226.00 for i in range(744)]
vol['xingo'] = [3800.00 for i in range(744)]
vol['canabrava'] = [2300.00 for i in range(744)]
vol['saosalvador'] = [952.00 for i in range(744)]
vol['estreito'] = [5400.00 for i in range(744)]
vol['lajeado'] = [4940.00 for i in range(744)]
