...
#valores da transposição (70% da Q95 de cada mês entre 1993-2020)
...
plotarENA(graf1, ENAbacia['BHSF'], 'ENA para BHSF / 1931-2020 / Cenário 2')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim([0, 45000])
plt.tight_layout()
plt.savefig('ENABHSFcen2.png')

fig2 = plt.figure(figsize=(16,5))
graf2 = fig2.add_subplot(axes_class=Axes)
plotarENA(graf2, ENAbacia['BHTOC'], 'ENA para BHTOC / 1931-2020 / Cenário 2')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim([0, 45000])
plt.tight_layout()
plt.savefig('ENABHTOCcen2.png')

fig3 = plt.figure(figsize=(16,5))
graf3 = fig3.add_subplot(axes_class=Axes)
plotarEAR(graf3, propEAR['BHSF'], '%EAR para BHSF / 1931-2020 / Cenário 2')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim(0, 105)
plt.tight_layout()
plt.savefig('EARBHSFcen2.png')

fig4 = plt.figure(figsize=(16,5))
graf4 = fig4.add_subplot(axes_class=Axes)
plotarEAR(graf4, propEAR['BHTOC'], '%EAR para BHTOC / 1931-2020 / Cenário 2')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim(0, 105)
plt.tight_layout()
plt.savefig('EARBHTOCcen2.png')