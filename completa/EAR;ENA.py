...
try:
	seriesena = pd.read_csv('seriesena.csv')
except:
	seriesena = pd.DataFrame()
	seriesena.to_csv('seriesena.csv',index=False)
...
for bacia in ENAbacia:
	if bacia == 'BHSF':
		serie = pd.Series(ENAbacia[bacia])
		seriesena = seriesena.assign(bhsf=serie.values)
		seriesena.to_csv('seriesena.csv', index=False)
	else:
		serie = pd.Series(ENAbacia[bacia])
		seriesena = seriesena.assign(bhtoc=serie.values)
		seriesena.to_csv('seriesena.csv', index=False)
'''
#plot
...
plotarENA(graf1, ENAbacia['BHSF'], 'ENA para BHSF / 1931-2020')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim([0, 45000])
plt.tight_layout()
plt.savefig('ENABHSFfull.png')

fig2 = plt.figure(figsize=(16,5))
graf2 = fig2.add_subplot(axes_class=Axes)
plotarENA(graf2, ENAbacia['BHTOC'], 'ENA para BHTOC / 1931-2020')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim([0, 45000])
plt.tight_layout()
plt.savefig('ENABHTOCfull.png')

fig3 = plt.figure(figsize=(16,5))
graf3 = fig3.add_subplot(axes_class=Axes)
plotarEAR(graf3, propEAR['BHSF'], '%EAR para BHSF / 1931-2020')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim(0, 105)
plt.tight_layout()
plt.savefig('EARBHSFfull.png')

fig4 = plt.figure(figsize=(16,5))
graf4 = fig4.add_subplot(axes_class=Axes)
plotarEAR(graf4, propEAR['BHTOC'], '%EAR para BHTOC / 1931-2020')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim(0, 105)
plt.tight_layout()
plt.savefig('EARBHTOCfull.png')
'''
'''
