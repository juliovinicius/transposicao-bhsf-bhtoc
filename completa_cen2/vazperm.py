...
q90 = {'Jan': [],'Fev': [],'Mar': [],'Abr': [],'Mai': [],'Jun': [],'Jul': [],'Ago': [],'Set': [],'Out': [],'Nov': [],'Dez': []}
...
#calculando o q90 para cada mês
for mes in permmes:
	for i in range(len(permmes[mes])):
		if permmes[mes][i] >= 0.9:
			q90[mes] = seriemesdesc[mes][i-1] * permmes[mes][i-1] / 0.9
			break
	print('Mês: {} / Q90: {:.2f} m³/s'.format(mes,q90[mes]))