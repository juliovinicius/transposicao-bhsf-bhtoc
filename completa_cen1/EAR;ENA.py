...
#valores da transposição (70% da Q95 Anual 1993-2020)
...
for uhe in mediaanoqnat:
	if uhe in ('pamx', 'xingo', 'canabrava', 'saosalvador', 'estreito', 'lajeado'):
		...
		for i, r in vazreg.iterrows():
			...
			print('Grau de regularização da UHE {}: {}.'.format(uhe,grau[uhe]))
...
for uhe in prodeq_65:
	ENA[uhe] = []
	i = 0
	for index, r in vaznat.iterrows():
		if i == 12:
			i = 0
		if uhe in ('sobradinho', 'itaparica', 'pamx', 'xingo'):
			ENA[uhe].append(prodeq_65[uhe] * (r[uhe] + transp[i]))
		elif uhe in ('estreito', 'tucurui'):
			ENA[uhe].append(prodeq_65[uhe] * (r[uhe] - transp[i]))
		else:
...
def plotarENA(graf, serie, titulo):
	...
	graf.xaxis.set_major_locator(plt.MaxNLocator(15))
...
plotarENA(graf1, ENAbacia['BHSF'], 'ENA para BHSF / 1931-2020 / Cenário 1')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim([0, 45000])
plt.tight_layout()
plt.savefig('ENABHSFcen1.png')

fig2 = plt.figure(figsize=(16,5))
graf2 = fig2.add_subplot(axes_class=Axes)
plotarENA(graf2, ENAbacia['BHTOC'], 'ENA para BHTOC / 1931-2020 / Cenário 1')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim([0, 45000])
plt.tight_layout()
plt.savefig('ENABHTOCcen1.png')

fig3 = plt.figure(figsize=(16,5))
graf3 = fig3.add_subplot(axes_class=Axes)
plotarEAR(graf3, propEAR['BHSF'], '%EAR para BHSF / 1931-2020 / Cenário 1')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim(0, 105)
plt.tight_layout()
plt.savefig('EARBHSFcen1.png')

fig4 = plt.figure(figsize=(16,5))
graf4 = fig4.add_subplot(axes_class=Axes)
plotarEAR(graf4, propEAR['BHTOC'], '%EAR para BHTOC / 1931-2020 / Cenário 1')
plt.xlim("Jan/1931", "Dez/2020")
plt.ylim(0, 105)
plt.tight_layout()
plt.savefig('EARBHTOCcen1.png')
